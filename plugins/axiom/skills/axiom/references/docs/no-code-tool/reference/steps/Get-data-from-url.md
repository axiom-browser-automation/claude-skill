...
description: Scrape data from a URL including images, HTML, and text. Point and click to select the data you wish to extract.
category: Scrape
icon: WidgetDriverSmartScraper.svg
---

::HeroMedia{video="https://www.youtube.com/embed/PCYHijmR0jY?rel=0&amp;start=1283&end=1503&rel=0"}
::
